...
/*/{Protheus.doc} User Function GRSZ7
...
Local aRotina := FwMvcMenu("GRSZ7")

/*Segunda Opção de Menu
Local aRotina := {}

ADD OPTION aRotina TITLE 'Visualizar'   ACTION 'VIEWDEF.GRSZ7'   OPERATION 2 ACCESS 0
ADD OPTION aRotina TITLE 'Incluir'      ACTION 'VIEWDEF.GRSZ7'   OPERATION 3 ACCESS 0
ADD OPTION aRotina TITLE 'Alterar'      ACTION 'VIEWDEF.GRSZ7'   OPERATION 4 ACCESS 0
ADD OPTION aRotina TITLE 'Excluir'      ACTION 'VIEWDEF.GRSZ7'   OPERATION 5 ACCESS 0
...
ADD OPTION aRotina TITLE 'Visualizar'   ACTION 'VIEWDEF.GRSZ7'  OPERATION  MODEL_OPERATION_VIEW      ACCESS 0
ADD OPTION aRotina TITLE 'Incluir'      ACTION 'VIEWDEF.GRSZ7'  OPERATION  MODEL_OPERATION_INSERT    ACCESS 0
ADD OPTION aRotina TITLE 'Alterar'      ACTION 'VIEWDEF.GRSZ7'  OPERATION  MODEL_OPERATION_UPDATE    ACCESS 0
ADD OPTION aRotina TITLE 'Excluir'      ACTION 'VIEWDEF.GRSZ7'  OPERATION  MODEL_OPERATION_DELETE    ACCESS 0
*/
...
Local oModel        := MPFormModel():New("GRSZ7m",/*bPre*/, /*bPos*/, bVldCom /*bCommit*/,/*bCancel*/)
...
/*Faço o Load do Movel referente à função/fonte GRSZ7, sendo assim se este Model
 estivesse em um outro fonte eu poderia pegar de lá, sem ter que copiar tudooo de novo
 */
Local oModel        := FwLoadModel("GRSZ7")
